...
const FullScreen = ({ primaryColor, iconsColor }: FullScreenProps) => {
  const { isFullScreen, dispatch, handle } = useVideo() as {
  ...
  return (
    <Button
      onClick={onToggleFullScreenHandler}
      primaryColor={primaryColor}
      tooltipId="fullscreen"
      tooltipContent="Full Screen (F)"
    >
      {isFullScreen ? (
        <svg
          viewBox="0 0 24 24"
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            {" "}
            <title>fullscreen_exit_fill</title>{" "}
            <g
              id="页面-1"
              stroke="none"
              stroke-width="1"
            ...
            >
              {" "}
              <g id="Media" transform="translate(-432.000000, -48.000000)">
                {" "}
                <g
                  id="fullscreen_exit_fill"
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            ...
            >
              {" "}
              <g id="Media" transform="translate(-480.000000, -48.000000)">
                {" "}
                <g
                  id="fullscreen_fill"
